...
<body>
    <div class="container-fluid g-0">
        ...
        $fotos = ["rio.jpg", "jalapao.jpg", "diamantina.jpg", "avatar.jpg"];
        ...
        ?>
            ...
            <div class="mb-3">
                <div class="row">
                    <div class="col-2">
                        <img src="img/monke.jpg" class="img-fluid" style="border-radius: 50px;">
                    </div>
                    <div class="col g-0">
                        <h6 class="mb-0 mt-1">Zé do oclin</h6>
                        <p>Americana</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-9  d-flex justify-content-start">
                        <i class="bi bi-heart" style="margin-right: 10px;"></i>
